...
function deleteUselessSemicolonsAtTheEnd(string) {
    if (string[(string.length)-1] !== ';'){
        return string;
    }
    string = string.pop();
    return deleteUselessSemicolonsAtTheEnd(string);
}
...
function printBooks(s) {
    ...
    s = s.split(';');
    s = deleteUselessSemicolonsAtTheEnd(s);
